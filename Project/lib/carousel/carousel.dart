...
class _CarouselWidgetState extends State<CarouselWidget> {
  ...
  Widget _buildCarouselItem(BuildContext context, int index) {
   // double? padding = widget.itemList[index].padding;
 //   double? borderRadius = widget.itemList[index].borderRadius;
  //  MaterialColor? color = widget.itemList[index].color;
    return Padding(padding: EdgeInsets.symmetric(horizontal: 0.5),
